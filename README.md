...
- [#4380](https://github.com/UKGovernmentBEIS/inspect_ai/pull/4380) - Add instance parameter and path canonicalization to memory
- [#4035](https://github.com/UKGovernmentBEIS/inspect_ai/pull/4035) - Krippendorff's α metric for multi-judge agreement
